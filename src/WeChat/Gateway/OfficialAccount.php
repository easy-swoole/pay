...
use EasySwoole\Pay\WeChat\RequestBean\OfficialAccount as OffcialAccountRequest;
use \EasySwoole\Pay\WeChat\ResponseBean\OfficialAccount as OfficiaAccountResponse;

class OfficialAccount extends PayBase
{

    public function pay(OffcialAccountRequest $officialAccount): OfficiaAccountResponse
    {
